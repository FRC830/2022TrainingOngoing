...
void Robot::TeleopPeriodic() {
  ...
  backSpinTalon.Set(ctre::phoenix::motorcontrol::TalonFXControlMode::PercentOutput, -1);
  }
  
  else{
  leftFlywheelTalon.Set(ctre::phoenix::motorcontrol::TalonFXControlMode::PercentOutput, 0);
  rightFlywheelTalon.Set(ctre::phoenix::motorcontrol::TalonFXControlMode::PercentOutput, 0);
